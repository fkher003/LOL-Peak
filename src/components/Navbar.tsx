      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {riotVersion && (
                <span className="hidden sm:inline-flex items-center rounded-full border border-slate-800 bg-slate-900 px-2 py-0.5 text-[10px] font-mono text-slate-400">
                  v{riotVersion}
                </span>
              )}
            </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-xl border px-2.5 py-2 text-xs font-semibold transition-colors ${
              hasApiKey
            ...
            title={hasApiKey ? 'API Key: Đã lưu (Click để đổi)' : 'API Key: Chưa có (Click để nhập)'}
          >
